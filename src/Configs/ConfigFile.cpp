...
std::string ConfigFile::display() const
{
    ...
    out << string(padLine, '=') << endl
        ...
        << left << tab << tab << setw(padSize) << setfill(padChar) << "removeThresholdInsideBounds"  << sep << removeThresholdInsideBounds  << endl
        << left << tab << tab << setw(padSize) << setfill(padChar) << "removeThresholdOutsideBounds" << sep << removeThresholdOutsideBounds << endl
        << left << tab << tab << setw(padSize) << setfill(padChar) << "removeScoreInsideBounds"      << sep << removeScoreInsideBounds      << endl
        << left << tab << tab << setw(padSize) << setfill(padChar) << "removeScoreOutsideBounds"     << sep << removeScoreOutsideBounds     << endl
        << left << tab << tab << setw(padSize) << setfill(padChar) << "createThreshold"              << sep << createThreshold              << endl
        << left << tab << tab << setw(padSize) << setfill(padChar) << "createScore"                  << sep << createScore                  << endl
