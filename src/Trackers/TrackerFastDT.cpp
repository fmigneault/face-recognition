...
TrackerFastDT::TrackerFastDT(ConfigFile *configFile) :
	m_pLearner(0),
...
TrackerFastDT::TrackerFastDT(const TrackerFastDT &obj)
{
...
TrackerFastDT & TrackerFastDT::operator=(const TrackerFastDT &obj)
{
...
void TrackerFastDT::initialize(const ImageRep& image, FloatRect bb)
{
    if (m_initialized)
		reset();
	m_bb = IntRect(bb);
...
cv::Rect TrackerFastDT::track(const ImageRep& image)
{
...
void TrackerFastDT::updateLearner(const ImageRep& image)
{
